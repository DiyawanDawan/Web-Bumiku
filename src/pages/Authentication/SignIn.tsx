...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    try {
      const response = await DBSourse.login(password, email, );
      if (response.token) {
        ...
        <div className="flex items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            ...
            <Link className="mb-5.5 inline-block" to="/">
              ...
              <p className="2xl:px-20">
                Lihatlah seberapa jauh dunia ini rusak oleh manusia
              </p>
          ...
          <div className="w-full border-stroke dark:border-indigo-200 xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Tata ulang dunia</span>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-slate-300 bg-gray p-4 hover:bg-opacity-50 dark:border-slate-400 dark:bg-meta-4 dark:hover:bg-opacity-50">
                  <span>
                    <FcGoogle size={30}/>
                  </span>
                  Masuk dengan Google
